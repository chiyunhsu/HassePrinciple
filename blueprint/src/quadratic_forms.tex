...
\begin{proof}
\leanok
\uses{lem:represents_of_hyperbolic}
...
The restriction of $Q$ to the submodule $U := Kx \oplus Ky$ is the desired hyperbolic form $H$. Take $Q'$ to be the restriction of $Q'$ to the orthogonal complement of $U$; then $Q$ is equivalent to $H + Q'$. %TODO: add reference
