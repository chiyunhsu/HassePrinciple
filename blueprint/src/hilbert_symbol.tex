...
\begin{proof}
	...
	\noindent\textbf{Case 1} Suppose $v_x=v_y=0$. Then $x=u_x$ and $y=u_y$ are units. The claim is
		...
		This proof uses \code{ZMod.exists_sq_eq_two_iff} in \code{Mathlib.NumberTheory.LegendreSymbol.QuadraticReciprocity} and \code{hensels_lemma} in \code{Mathlib.NumberTheory.Padics.Hensel}
...
\begin{theorem}\label{thm:existence}
	\lean{hilbertSym.exists_rat_with_prescribed_hilbert_symbols_at_finitely_many_places}
	\uses{def:Hilbert_symbol}
	\leanok
